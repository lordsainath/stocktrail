...
<template>
  <div
    class="flex justify-between items-center px-5 py-3 bg-white border-b border-b-[#e2e8f0] dark:border-b-[#30363d] dark:bg-darkprimary dark:text-white"
  >
    ...
    <div class="flex gap-2 items-center">
      ...
      >
        <Sun v-show="theme === 'light'" size="18" />
        <MoonIcon v-show="theme === 'dark'" size="18" />
      </div>
      ...
      <template v-else>
        <button
          class="bg-red-500 text-white px-5 py-2 cursor-pointer rounded-md"
          @click="handleLogout"
        >
          Logout
        </button>
