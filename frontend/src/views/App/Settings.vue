...
<template>
  <div
    class="min-h-[calc(100vh-65px)] p-5 sm:p-7 bg-[radial-gradient(circle_at_top_left,#dbeafe_0%,#f8fafc_45%,#f1f5f9_100%)] dark:bg-[radial-gradient(circle_at_top_left,#1f2937_0%,#0f172a_45%,#020617_100%)]"
  >
    <div class="max-w-6xl mx-auto">
      ...
      >
        ...
        <p class="mt-2 text-sm text-slate-600 dark:text-slate-300">
          Choose how NiftyNest should look while you trade and manage your account.
        </p>
