...
const handleAddMoney = async () => {
  const result = await walletStore.addMoneyToWallet();
    ...
    <div class="max-w-6xl mx-auto space-y-5">
          ...
          <div class="mt-4 space-y-3 max-h-90 overflow-y-auto pr-1">
            ...
            <div v-for="item in walletStore.recentTransfers" :key="item.createdAt + item.reference"
              ...
              <div class="mt-2 flex items-center justify-between">
                ...
                <i v-if="item.status === 'SUCCESS'" class="fa-solid fa-circle-check text-emerald-500"></i>

                <i v-else-if="item.status === 'PENDING'" class="fa-regular fa-clock text-amber-500"></i>
      ...
      <div v-if="showAddBankModal" tabindex="0"
        ...
        <div
          ...
          <form class="mt-4 grid sm:grid-cols-2 gap-3" @submit.prevent="walletStore.addBankAccount">
            <BaseInput v-model="walletStore.addBankForm.bankName" label="Bank Name" placeholder="Enter bank name"
              required />

            <BaseInput v-model="walletStore.addBankForm.accountHolder" label="Account Holder"
              placeholder="Enter account holder name" required />

            <BaseInput v-model="walletStore.addBankForm.accountNumber" label="Account Number"
              placeholder="Enter account number" required />

            <BaseInput v-model="walletStore.addBankForm.ifsc" label="IFSC Code" placeholder="Enter IFSC code"
              class="uppercase" required />

            <div class="sm:col-span-2">
              <BaseSelect v-model="walletStore.addBankForm.accountType" label="Account Type" required>
            ...
            <div class="sm:col-span-2 flex justify-end gap-2 mt-1">
              <BaseButton type="button" variant="secondary" :full-width="false" @click="showAddBankModal = false">
                Cancel
              </BaseButton>
      ...
      <div v-if="showAddMoneyModal"
        ...
        <div
          ...
          <select v-model="walletStore.addMoneyForm.bankAccountId"
          ...
          <input v-model="walletStore.addMoneyForm.amount" type="number" min="1" step="0.01" placeholder="Enter amount"
          ...
          <div class="mt-2 flex justify-center">
            <VOtpInput v-model:value="walletStore.addMoneyForm.pin" :num-inputs="4" input-type="number" separator=""
              input-classes="
          ...
          <div class="mt-4 flex justify-end gap-2">
            ...
            <BaseButton variant="primary" :full-width="false" :disabled="walletStore.loading"
