      ...
      <div v-if="showAddBankModal" tabindex="0"
        ...
        <div
          ...
          <form class="mt-4 grid sm:grid-cols-2 gap-3" @submit.prevent="walletStore.addBankAccount">
            <input v-model="walletStore.addBankForm.bankName" type="text" placeholder="Bank name"
              class="px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800" />

            <input v-model="walletStore.addBankForm.accountHolder" type="text" placeholder="Account holder"
              class="px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800" />

            <input v-model="walletStore.addBankForm.accountNumber" type="text" placeholder="Account number"
              class="px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800" />

            <input v-model="walletStore.addBankForm.ifsc" type="text" placeholder="IFSC"
              class="px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800" />

            <select v-model="walletStore.addBankForm.accountType"
