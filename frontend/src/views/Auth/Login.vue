    ...
    <div class="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      >
        <div>
          ...
          <p class="mt-4 text-slate-600 dark:text-slate-300 leading-relaxed">
            Continue with secure sign in, then verify PIN to unlock your dashboard and portfolio
            controls.
          </p>
        </div>
      ...
      >
        <div class="flex flex-col items-center mb-8">
          <div
            class="w-14 h-14 bg-primary rounded-2xl flex items-center justify-center mb-4 shadow-sm"
          >
