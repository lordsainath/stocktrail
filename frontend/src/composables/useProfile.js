...
import { formatAddress } from '@composables/useProfileHelpers';
...
export function useProfile() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const response = await profileStore.fetchCurrentProfile();
  ...
  const updatePassword = async () => {
    ...
    try {
      ...
      const response = await profileStore.updatePassword(passwordForm.password);
  ...
  const updatePin = async () => {
    ...
    try {
      ...
      const response = await profileStore.updatePin(pinForm.pin);
